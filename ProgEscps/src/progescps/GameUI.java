 ...
 * - In-game "MainMenu" button prompts for confirmation before returning to the main menu.
 * - "New Game" prompts for confirmation (will lose current progress) when invoked from inside a running game.
 * - "Quit" from the main menu prompts for confirmation.
 * - Class-selection dialog and main game console follow the shared color scheme.
 * - When starting a confirmed New Game from inside the game, the console is cleared before starting.
 *
 * InputProvider and GameManager integration remains unchanged.
 */
public class GameUI {
    ...
    private static final java.awt.Color CONSOLE_BG = new java.awt.Color(10, 60, 40);
    ...
    private JPanel createMainMenuPanel() {
        ...
        // Button actions
        menuStartBtn.addActionListener(e -> showClassSelectionDialog()); // from main menu, no "Are you sure" needed
    ...
    private JPanel createGamePanel() {
        ...
        newBtn.addActionListener(e -> {
            ...
            if (ok) {
                consoleArea.setText(""); // clear console so new game starts fresh
                showClassSelectionDialog(); // opens class selection and starts game
            }
        });
        ...
        consoleArea.setBackground(CONSOLE_BG); // dark green console bg
        ...
        // make send button slightly smaller visually
    ...
    private void showClassSelectionDialog() {
        ...
        // Action listeners: start new game with chosen class and switch to GAME card
